...
import com.smartmind.ms.account.dto.ErrorResponseDto;
...
public class CustomerController {
    ...
    public ResponseEntity<CustomerDetailsDto> fetchCustomerDetails(@RequestHeader("custom-uuid")String correlationId,@RequestParam
